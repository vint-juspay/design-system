  ...
  const renderNavbar = () => (
    <div className="bg-gray-100 p-4 mb-8 rounded-lg">
      <div className="flex gap-4">
        <Button 
          buttonType={activeComponent === 'buttons' ? 'primary' : 'secondary'} 
          size="md"
        ...
        <Button 
          buttonType={activeComponent === 'tooltips' ? 'primary' : 'secondary'} 
          size="md"
        ...
        <Button 
          buttonType={activeComponent === 'tags' ? 'primary' : 'secondary'} 
          size="md"
