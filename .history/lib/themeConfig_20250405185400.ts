...
export const themeConfig = {
  euler: {
    ...
    tag: {
      variant: {
        default: {
          neutral: 'bg-gray-0 text-gray-700 border border-gray-950',
          primary: 'bg-gray-0 text-blue-700 border border-blue-600',
          success: 'bg-gray-0 text-green-700 border border-green-600',
          error: 'bg-gray-0 text-red-700 border border-red-600',
          warning: 'bg-gray-0 text-amber-700 border border-orange-500',
          purple: 'bg-gray-0 text-purple-700 border border-purple-500'
        },
        attentive: {
      ...
      splitTag: {
        neutral: {
          left: 'bg-gray-200 text-gray-800',
          right: 'bg-gray-100 text-gray-700'
        },
        primary: {
